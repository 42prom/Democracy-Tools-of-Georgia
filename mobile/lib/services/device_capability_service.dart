...
class DeviceCapabilityProfile {
  ...
  bool get canUsePassiveLiveness =>
      cameraQuality != CameraQuality.low &&
...
class DeviceCapabilityService {
  ...
  static Future<DeviceCapabilityProfile> _detectAndroid() async {
    ...
    final cameraQuality = _estimateAndroidCameraQuality(
      info.model,
      info.manufacturer,
    );
  ...
  static ProcessingPower _estimateAndroidProcessingPower(
    int sdkInt,
    String model,
  ) {
    // High-end indicators
  ...
  static CameraQuality _estimateAndroidCameraQuality(
    String model,
    String manufacturer,
  ) {
