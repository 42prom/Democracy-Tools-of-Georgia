...
class LocalizationService extends ChangeNotifier {
  ...
  static const Map<String, String> _englishTranslations = {
    ...
    'survey_analyzed':
        'Thank you for your participation.\nSurvey results are analyzed by authorized staff.',
    ...
    'leaf_hash': 'Leaf Hash (your vote fingerprint)',
    'merkle_root': 'Merkle Root (all votes committed)',
    'ed25519_signature': 'Server Signature (Ed25519)',
    'algorithm': 'Algorithm',
    'vote_id': 'Vote ID',
    'copy_to_clipboard': 'Copy',
    'copied': 'Copied!',
    'verify_independently': 'Verify Independently',
    'verify_independently_tip':
        'Use the leaf hash to verify your vote inclusion at any time',
  ...
  static const Map<String, String> _georgianTranslations = {
    ...
    'survey_analyzed':
        'გმადლობთ მონაწილეობისთვის.\nგამოკითხვის შედეგებს გააანალიზებს უფლებამოსილი პერსონალი.',
    ...
    'cryptographic_proof': 'კრიპტოგრაფიული დასტური',
    'cryptographic_proof_subtitle': 'გადაამოწმეთ ხმის ჩართვა დამოუკიდებლად',
    'leaf_hash': 'ფოთლის ჰეში (თქვენი ხმის ანაბეჭდი)',
    'merkle_root': 'მერკლის ფესვი (ყველა ხმა)',
    'ed25519_signature': 'სერვერის ხელმოწერა (Ed25519)',
    'algorithm': 'ალგორითმი',
    'vote_id': 'ხმის ID',
    'copy_to_clipboard': 'კოპირება',
    'copied': 'დაკოპირდა!',
    'verify_independently': 'დამოუკიდებელი გადამოწმება',
    'verify_independently_tip':
        'ფოთლის ჰეშის გამოყენებით გადაამოწმეთ ხმა ნებისმიერ დროს',
