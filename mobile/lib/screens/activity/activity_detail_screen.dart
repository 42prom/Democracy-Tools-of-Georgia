...
class _ActivityDetailScreenState extends State<ActivityDetailScreen> {
  ...
  Widget build(BuildContext context) {
    return Consumer<LocalizationService>(
      builder: (context, loc, child) {
        ...
        final typeKey = widget.item.type.toLowerCase();

        return Scaffold(
          appBar: AppBar(title: Text(loc.translate('activity_detail'))),
          body: SafeArea(
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Question
                  if (widget.item.referendumQuestion != null ||
                      widget.item.electionQuestion != null) ...[
                    ...
                    Container(
                      ...
                      child: Text(
                        widget.item.referendumQuestion ??
                            widget.item.electionQuestion!,
                      ...
                      child: Column(
                        children: [
                          _infoRow(
                            context,
                            loc.translate('type'),
                            loc.translate(typeKey),
                          ),
                          const Divider(height: 24),
                          _infoRow(
                            context,
                            loc.translate('voted_on'),
                  ...
                  if (_isSurvey)
                    _buildSurveyCompletedMessage(context, loc)
                  else if (ended)
                    _buildResultsSection(context, loc)
                  else
                    _buildLockedMessage(context, loc),
                ],
              ),
            ),
          ),
  ...
  Widget _buildSurveyCompletedMessage(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 16),
            Text(
              loc.translate('activity_survey_submitted'),
  ...
  Widget _buildLockedMessage(BuildContext context, LocalizationService loc) {
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 16),
            Text(
              loc.translate('results_available_after_ends'),
              style: Theme.of(context).textTheme.titleMedium?.copyWith(
            ...
            const SizedBox(height: 8),
            Text(
              loc.translate('check_back_for_outcome'),
              style: Theme.of(
                context,
              ).textTheme.bodyMedium?.copyWith(color: Colors.grey),
              textAlign: TextAlign.center,
  ...
  Widget _buildResultsSection(BuildContext context, LocalizationService loc) {
    if (_isLoading) {
      return const Center(
        child: Padding(
    ...
    return Card(
      child: Padding(
        ...
        child: Column(
          children: [
            // Your Vote Section
            if (widget.item.votedOptionText != null) ...[
              Container(
                ...
                child: Column(
                  children: [
                    Text(
                      loc.translate('your_vote').toUpperCase(),
            ...
            const SizedBox(height: 8),
            Text(
              '$totalVotes ${loc.translate('total_votes')}',
              style: Theme.of(
                context,
              ).textTheme.bodyMedium?.copyWith(color: Colors.grey),
            ),
