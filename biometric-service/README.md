...
The high-performance identity verification core of the **Democracy Tools of Georgia** system. This service provides AI-powered face matching and liveness detection to ensure "one-person-one-vote" integrity.

Built using **InsightFace**, **ONNX Runtime**, and **FastAPI**.
