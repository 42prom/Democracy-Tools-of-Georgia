 ...
 * @description Handles core biometric verification logic including rate limiting,
 *              provider strategy selection (InsightFace/Liveness), and scoring.
 *              Enforces strict 1:1 face matching and liveness checks.
 */
 ...
 * 
 * Tiers:
 * - Tier 1 (Pass): Score >= 0.8 (High confidence)
 * - Tier 2 (Retry): 0.6 <= Score < 0.8 (Marginal, allows retry)
 * - Tier 3 (Fail): Score < 0.6 (Strict rejection)
 */
