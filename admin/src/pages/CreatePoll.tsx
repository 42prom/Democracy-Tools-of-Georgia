...
export default function CreatePoll() {
  ...
  // Referendum
  const [referendumQuestion, setReferendumQuestion] = useState('');
  ...
  const canPublish = () => {
    ...
    if (pollType === 'referendum') {
      return referendumQuestion.trim() !== '' &&
        referendumOptions.filter((opt) => opt.text.trim() !== '').length >= 2;
    }
  ...
  const handleSaveDraft = async () => {
    ...
    try {
      ...
      if (pollType === 'survey' && surveyQuestions.some((q) => q.questionText.trim() !== '')) {
        ...
        pollData.referendum_question = referendumQuestion;
            ...
            <Card>
              ...
              <div className="space-y-4">
                <Textarea
                  ...
                  placeholder="e.g., Do you support Georgia's membership in the European Union?"
                  rows={2}
                  value={referendumQuestion}
                  onChange={(e) => setReferendumQuestion(e.target.value)}
                />
                ...
                {referendumQuestion && (
                  <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                    ...
                    <p className="text-gray-900 font-medium mb-3">{referendumQuestion}</p>
