...
import { X, Download, FileSpreadsheet, AlertCircle, CheckCircle, Loader2, Calendar, Shield } from 'lucide-react';
        ...
        <div className="relative bg-white rounded-xl shadow-xl max-w-lg w-full">
          ...
          <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-lg font-semibold text-gray-900">Export Audit Data</h2>
                <p className="text-sm text-gray-500 truncate max-w-xs">{pollTitle}</p>
              </div>
            </div>
            <button
              onClick={onClose}
